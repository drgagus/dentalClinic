                    ...
                    <form method="POST" action="/admin/user/{{$user->id}}/edit">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control @error('jabatan') is-invalid @enderror" id="jabatan" name="jabatan" autofocus>
                                ...
                                <option  {{ old('jabatan') ?? $user->jabatan === 'perawat gigi' ? 'selected':'' }} value="perawat gigi" >Perawat Gigi</option>
                                ...
                                <option  {{ old('jabatan') ?? $user->jabatan === 'non-medis' ? 'selected':'' }} value="non-medis" >Non-medis</option>
                                <option  {{ old('jabatan') ?? $user->jabatan === 'akuntan' ? 'selected':'' }} value="akuntan" >Akuntan</option>
                            </select>
