                ...
                <div class="card-body">
                    <form method="POST" action="/admin/service">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tindakan" type="text" class="form-control @error('tindakan') is-invalid @enderror" name="tindakan" value="{{ old('tindakan') }}" autocomplete="tindakan" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="doktergigi" type="doktergigi" class="form-control @error('doktergigi') is-invalid @enderror" name="doktergigi" value="{{ old('doktergigi') }}" autocomplete="Jasa dokter gigi">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="diskon" type="diskon" class="form-control @error('diskon') is-invalid @enderror" name="diskon" value="{{ old('diskon') }}" autocomplete="diskon">
