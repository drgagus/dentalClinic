...
<div class="container">
  <a class="navbar-brand" href={{route('ceo')}}>CEO/OWNER</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href={{url("/ceo/service")}}>Income Jasa</a>
          <a class="dropdown-item" href={{url("/ceo/medicine")}}>Income Obat</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href={{url("/ceo/income/dentist")}}>Income Dokter Gigi</a>
        </div>
      </li>
      </li>
      <li class="nav-item">
