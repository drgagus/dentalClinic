                    ...
                    @if(date(('Y'), strtotime($dentalrecord->tanggalkunjungan)) == $tahun )
                        @if(date(('m'), strtotime($dentalrecord->tanggalkunjungan)) == $bulan )
                            <tr class="">
                                ...
                                <?php $jasa = $jasa + $dentaltreatment->harga ; $jasadokter = $jasadokter + $dentaltreatment->doktergigi ;?>
                                   <table class="" style="width:100%">
                                        <tr class="">
                                            <td class="" style="width:25%">{{$dentaltreatment->cost->tindakan}}</td>
                                            <td class="" style="width:25%">Rp. {{number_format($dentaltreatment->harga, 0, ",", ".")}},-</td>
                                            <td class="" style="width:25%">Rp. {{number_format($dentaltreatment->doktergigi, 0, ",", ".")}},-</td>
                    ...
                    <th class="">
                        <table class="" style="width:100%">
                            <tr class="bg-secondary text-white">
                                <td class="" style="width:25%">Total</td>
                                <td class="" style="width:25%">Rp. {{number_format($jasa, 0, ",", ".")}},-</td>
                                <td class="" style="width:25%">Rp. {{number_format($jasadokter, 0, ",", ".")}},-</td>
                                <td class="" style="width:25%">Rp. {{number_format($jasa-$jasadokter, 0, ",", ".")}},-</td>
                            </tr>
                        </table>
                    </th>
                    <th class=""></th>
