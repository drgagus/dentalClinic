...
<div class="row">
    ...
    <div class="col-lg-2">
        <div class="form-group">
            <input type="text" class="form-control" id="jumlah" name="jumlah" value="{{ old('jumlah') ?? $obat->jumlah}}">
            @error('jumlah')<label class="text text-danger">Jumlah obat belum diisi atau tidak valid</label>@enderror
        </div>
    </div>
    <div class="col-lg-2">
        <div class="form-group">
            <input type="text" class="form-control" id="harga" name="harga" value="{{ old('harga') ?? $obat->harga}}" >
            @error('harga')<label class="text text-danger">Harga obat belum diisi atau tidak valid</label>@enderror
        </div>
    </div>
    <div class="col-lg-1">
        <div class="form-group">
        <input id="aktif" type="checkbox" name="aktif" {{$obat->aktif === 1  ? 'checked':'' }} value="1"> <label for="aktif" class="">Aktif</label>
        </div>
    </div>
