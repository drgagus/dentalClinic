  ...
  <li class="list-group-item d-flex justify-content-between align-items-center">
    ...
    <span class="">{{date(('d M Y'), strtotime($dentalrecord->tanggalkunjungan))}}</span>
      ...
      <div class="card-body text-dark">
          ...
          <div class="row">
              <div class="col-lg-6">
                    <table class="table table-hover">
                          ...
                          <?php $jasa=$jasa+$dentaltreatment->harga; ?>
                          <tr class="">
                              <td class="">#</td><td class="">{{$dentaltreatment->cost->tindakan}}</td><td class="">Rp. {{number_format($dentaltreatment->harga, 0, ",", ".")}},-</td>
                          </tr>
                          @endforeach
                          <tr class="">
              ...
              <div class="col-lg-6">
                    <table class="table table-hover">
                          ...
                          <?php 
                          $obat = $obat+$medicinerecord->harga
                          ?>
                          <tr class="">
                              <td class="">#</td><td class="">{{$medicinerecord->medicine->obat}}</td><td class="">{{$medicinerecord->jumlah}}</td><td class="">Rp. {{number_format($medicinerecord->harga, 0, ",", ".")}},-</td>
                          </tr>
                          @endforeach
                          <tr class="">
          ...
          <div class="row">
                <div class="col-lg-3">
                    <div class="font-weight-bold bg-dark text-white p-2">
                        Sudah dibayar Rp. {{number_format($jasa+$obat, 0, ",", ".")}},-
                    </div>
                </div>
          </div>
