  ...
  <div class="row">
      <div class="col-lg-12 p-0">
        <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active border border-info border-bottom-0" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">+DentalTreatment</a>
          </li>
        ...
        <div class="tab-content border border-info bg-light" id="myTabContent">
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" >
                <form action="/dentist/dentaltreatment" method="post" class="" enctype="multipart/form-data">
                  @csrf
                    ...
                    <table class="p-0 border" style="width:100%">
                      <tr class="border">
                            <td class="border" style="width:15%">
                                <textarea class="form-control @error('gigi') is-invalid @enderror" id="gigi" rows="2" name="gigi" Placeholder="--element gigi--">{{old('gigi')}}</textarea><br>
                            ...
                            <td class="border" style="width:65%">
                                <textarea class="form-control @error('tindakan') is-invalid @enderror" id="tindakan" rows="6" name="tindakan" Placeholder="--tindakan--">{{old('tindakan')}}</textarea>
                            </td>
                            ...
                            <td colspan="2" class="">
                                <select name="cost_id" id="" class="form-control @error('cost_id') is-invalid @enderror">
                                    ...
                                    @foreach ($costs as $cost)
                                        <option {{ old('cost_id')  === "$cost->id" ? 'selected':'' }} value="{{$cost->id}}">{{$cost->tindakan}} - Rp.{{number_format($cost->harga, 0, ",", ".")}},-</option>
                                    @endforeach
                                </select>
                            </td>
                            <td class="text-right"><button type="submit" class="btn btn-sm btn-primary">INPUT</button></td>
                        </tr>
                    </table>
                </form>
          </div>
